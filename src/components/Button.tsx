...
const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    ...
    outline:
      'border-2 border-primary-600 text-primary-600 hover:bg-primary-50 dark:border-primary-400 dark:text-primary-400 dark:hover:bg-primary-900 focus:ring-primary-500',
    ghost:
